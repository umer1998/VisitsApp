...
public class ExecutedFrag extends Fragment {
    ...
    public ExecutedFrag(MainActivity context) {
...
//            getExecutionEvent();
    ...
    private void getExecutionEvent() {
        ...
        serviceImp.getCompletedEvents( new ResponseCallBack<ArrayList<PlansData>>() {
            @Override
    ...
    private void setApdapter(ArrayList<PlansData> body) {
        ...
        executionAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ExecutedEventDetailDialogue dialog = new ExecutedEventDetailDialogue(context );
