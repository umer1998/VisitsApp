package com.example.visitsapp.ui.fragments.pending;
...
public class CalenderViewFrag extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rlcplan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CreatePlanDialogue dialog = new CreatePlanDialogue(context );
    ...
    private void getPlans() {
        ...
        serviceImp.plans(new ResponseCallBack<List<PlansData>>() {
            @Override
