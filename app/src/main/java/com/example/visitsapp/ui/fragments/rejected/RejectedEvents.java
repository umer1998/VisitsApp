package com.example.visitsapp.ui.fragments.rejected;
...
public class RejectedEvents extends BaseFragment {

    private TextView tvNoRecord;
    private RecyclerView recyclerView;
    private MainActivity context;

    public RejectedEvents(MainActivity context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_rejected_events, container, false);
