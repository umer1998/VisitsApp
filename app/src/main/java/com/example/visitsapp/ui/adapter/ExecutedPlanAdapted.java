...
public class ExecutedPlanAdapted extends RecyclerView.Adapter<ExecutedPlanAdapted.ViewHolder> {
    ...
    public ExecutedPlanAdapted(MainActivity context, ArrayList<PlansData> body) {
    ...
    public int getItemViewType(int position) {
        ...
        return R.layout.executed_adapter;
